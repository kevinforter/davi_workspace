const margin = { top: 10, right: 0, bottom: 20, left: 30 },
    containerWidth = document.querySelector("#chart").offsetWidth,
    containerHeight = document.querySelector("#chart").offsetHeight,
...
const svgMap = d3.select("#map").append("svg")
    .attr("viewBox", [0, 0, widthMap, heightMap])  // Keeps the SVG content proportionate
    ...
    d3.csv("assets/ava36.csv").then((data) => {
        ...
        function appendData(filteredData) {
            ...
            const legend = svg.append("g")
                .attr("transform", `translate(${width / 2 - 80},${height + 7.5})`);
